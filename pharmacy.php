    ...
    try {
        ...
        if (empty($name)) {
            ...
            if ($action === 'edit_medicine' && $medicine_id > 0) {
                ...
                // Insert new medicine
                $sql = "INSERT INTO medicines (name, category_id, description, price, stock_quantity, 
                                            ...
                                            <tbody>
                                                <?php foreach ($medicines as $med): ?>
                                                    <tr>
                                                        ...
                                                        <td class="price-tag">₹<?php echo number_format($med['price'] ?? 0, 2); ?></td>
                                                        <td>
                                                            <?php
                                ...
                                <form method="post" action="<?php echo $action === 'edit_medicine' ? "pharmacy.php?action=edit_medicine&id={$medicine_id}" : "pharmacy.php?action=new_medicine"; ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" step="0.01" min="0" class="form-control" id="price" name="price" value="<?php echo $medicine['price'] ?? '0.00'; ?>" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date" class="form-control" id="manufacturing_date" name="manufacturing_date" value="<?php echo $medicine['manufacturing_date'] ?? ''; ?>">
                                        </div>
                                        <div class="col-md-6 mb-3">
