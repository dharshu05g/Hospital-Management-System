        ...
        if ($patient_id <= 0) {
            ...
            if ($action === 'edit' && $invoice_id > 0) {
                ...
                $sql = "INSERT INTO invoices (
                        patient_id, invoice_date, due_date, total_amount, paid_amount, payment_status, 
                        discount_amount, tax_amount, notes
                    ) VALUES (
                        :patient_id, :invoice_date, :due_date, :total_amount, 0, 'pending', 
                        :discount_amount, :tax_amount, :notes
                    )";
                $params = [
                    ':patient_id' => $patient_id,
...
<body class="<?php echo ($action === 'print') ? 'print-mode' : ''; ?>">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-between mb-2">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <input type="number" step="0.01" min="0" class="form-control form-control-sm ms-2" id="tax_amount" name="tax_amount" value="<?php echo $invoice['tax_amount'] ?? '0.00'; ?>" style="width: 100px;">
                                                        </div>
                                                        <span class="price-tag" id="taxDisplay">₹0.00</span>
                                                    </div>
                                                    <div class="d-flex justify-content-between mb-2">
                                                        <div class="d-flex align-items-center">
                                                            <span>Discount:</span>
                                                            <input type="number" step="0.01" min="0" class="form-control form-control-sm ms-2" id="discount_amount" name="discount_amount" value="<?php echo $invoice['discount_amount'] ?? '0.00'; ?>" style="width: 100px;">
                                                        </div>
                                                        <span class="price-tag" id="discountDisplay">₹0.00</span>
                                                    </div>
                                                    <hr>
                                                ...
                                                <tbody>
                                                    <?php foreach ($available_services as $service): ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo ucfirst(str_replace('_', ' ', $service['type'])); ?></td>
                                                            <td>₹<?php echo number_format($service['price'], 2); ?></td>
                                                            <td>
                                                                <button type="button" class="btn btn-sm btn-primary add-service-btn"
                                                                    data-type="<?php echo $service['type']; ?>"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (addItemBtn && invoiceItemsBody) {
                ...
                document.addEventListener('click', function(e) {
                    if (e.target.classList.contains('remove-item') || e.target.parentElement.classList.contains('remove-item')) {
                        ...
                        if (invoiceItemsBody.children.length > 1) {
                            row.remove();
                            updateTotals();
                        } else {
                ...
                if (taxAmountInput && discountAmountInput) {
                ...
                addServiceBtns.forEach(btn => {
                    btn.addEventListener('click', function() {
                        ...
                        newRow.innerHTML = `
                            ...
                            <td>
                                <input type="number" step="0.01" min="0" class="form-control total-input" name="total_price[]" value="${price.toFixed(2)}" readonly>
                            </td>
                            <td>
                                <button type="button" class="btn btn-sm btn-danger remove-item"><i class="fas fa-times"></i></button>
                            </td>
