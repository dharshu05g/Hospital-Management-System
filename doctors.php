...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_doctor'])) {
    try {
        ...
        if (empty($name)) {
            ...
            if ($action === 'new') {
                // Insert new doctor using our helper function for XAMPP compatibility
                $doctorData = [
                    'name' => $name,
                ...
                $new_doctor_id = create_doctor_pdo($doctorData);
            ...
            <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select" id="specialization" name="specialization" required>
                                                ...
                                                <option value="general" <?php echo (isset($doctor['specialization']) && $doctor['specialization'] == 'general') ? 'selected' : ''; ?>>General</option>
                                                <option value="cardiology" <?php echo (isset($doctor['specialization']) && $doctor['specialization'] == 'cardiology') ? 'selected' : ''; ?>>Cardiology</option>
                                                <option value="neurology" <?php echo (isset($doctor['specialization']) && $doctor['specialization'] == 'neurology') ? 'selected' : ''; ?>>Neurology</option>
                                                <option value="orthopedics" <?php echo (isset($doctor['specialization']) && $doctor['specialization'] == 'orthopedics') ? 'selected' : ''; ?>>Orthopedics</option>
                                                <option value="pediatrics" <?php echo (isset($doctor['specialization']) && $doctor['specialization'] == 'pediatrics') ? 'selected' : ''; ?>>Pediatrics</option>
                                                <option value="dermatology" <?php echo (isset($doctor['specialization']) && $doctor['specialization'] == 'dermatology') ? 'selected' : ''; ?>>Dermatology</option>
                                                <option value="ophthalmology" <?php echo (isset($doctor['specialization']) && $doctor['specialization'] == 'ophthalmology') ? 'selected' : ''; ?>>Ophthalmology</option>
                                                <option value="gynecology" <?php echo (isset($doctor['specialization']) && $doctor['specialization'] == 'gynecology') ? 'selected' : ''; ?>>Gynecology</option>
                                                <option value="oncology" <?php echo (isset($doctor['specialization']) && $doctor['specialization'] == 'oncology') ? 'selected' : ''; ?>>Oncology</option>
                                                <option value="psychiatry" <?php echo (isset($doctor['specialization']) && $doctor['specialization'] == 'psychiatry') ? 'selected' : ''; ?>>Psychiatry</option>
                                                <option value="other" <?php echo (isset($doctor['specialization']) && $doctor['specialization'] == 'other') ? 'selected' : ''; ?>>Other</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date" class="form-control" id="joining_date" name="joining_date"
                                                value="<?php echo isset($doctor['joining_date']) ? htmlspecialchars($doctor['joining_date']) : ''; ?>">
                                        </div>
                    ...
                    <?php elseif ($action === 'schedule' && $doctor): ?>
                        ...
                        <div class="card shadow-sm mb-4">
                            <div class="card-header">
                                <h5 class="mb-0">Schedule for <?php echo htmlspecialchars($doctor['name']); ?></h5>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="doctors.php?action=schedule&id=<?php echo $doctor_id; ?>">
                                    ...
                                    <div class="mb-4 d-flex justify-content-between align-items-center">
                                        <div>
                                            <h6>Doctor: <span class="text-primary"><?php echo htmlspecialchars($doctor['name']); ?></span></h6>
                                            <?php if (!empty($doctor['specialization'])): ?>
                                                <p class="mb-0">Specialization: <span class="badge badge-specialization"><?php echo htmlspecialchars($doctor['specialization']); ?></span></p>
                                            <?php endif; ?>
                                        </div>
                        ...
                        <!-- This inline script is now handled by the global script at the bottom of the page -->
                        <!-- <script>
                            // Schedule management code moved to the main script
                        </script> -->
                                    ...
                                    const removeBtn = newRow.querySelector('.remove-schedule');
