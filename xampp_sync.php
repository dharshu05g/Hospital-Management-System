...
function create_doctor_pdo($doctorData) {
    ...
    try {
        $sql = "INSERT INTO doctors (name, department_id, specialization, qualification, email, phone, address, joining_date) 
                VALUES (:name, :department_id, :specialization, :qualification, :email, :phone, :address, :joining_date)";
        ...
        $params = [
            ...
            ':joining_date' => $doctorData['joining_date'] ?? null
        ];
